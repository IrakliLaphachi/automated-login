...
for i in range (1, 3):
    driver.find_element(By.CSS_SELECTOR, ".css-1ww8w0e > div:nth-child(1) > table:nth-child(1) > tbody:nth-child(2) > div:nth-child(1) > tr:nth-child(%i) > td:nth-child(1) > span:nth-child(1) > input:nth-child(1)"% int(i)).click()
