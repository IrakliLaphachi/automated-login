...
formRedirect = driver.find_element(By.CSS_SELECTOR, '.css-1ue1lp6')
ActionChains(driver).move_to_element(formRedirect).perform()
ActionChains(driver).click(formRedirect).perform()
time.sleep(1)

errorCheck = driver.find_element(By.CSS_SELECTOR, '.MuiPaper-root > h2').text

if errorCheck == "Unexpected Error":
    print("fail")
else:
    print("pass")
